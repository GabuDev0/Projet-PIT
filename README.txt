...
Finalement, le joueur doit supprimer un des deux fichiers générés après l'exécution de connect.sh. Après avoir en avoir supprimé un, il peut tester si c'était le bon avec le script finish.sh, et finalement terminer le jeu.
